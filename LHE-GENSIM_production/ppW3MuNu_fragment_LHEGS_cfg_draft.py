...
# with command line options: Configuration/GenProduction/python/ppW3MuNu_fragment.py --python_filename ppW3MuNu_fragment_LHEGS_cfg_draft.py --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --fileout file:ppW3MuNu_Run3Summer22EEwmLHEGS.root --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(22) --no_exec -n 12
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ppW3MuNu_fragment.py nevts:#NUMBEREVENTS#'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ppW3MuNu_Run3Summer22EEwmLHEGS.root'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(#RANDOM_STATE#)
