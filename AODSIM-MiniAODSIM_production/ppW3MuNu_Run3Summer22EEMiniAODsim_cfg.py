...
# with command line options: step1 --mc --python_filename ppW3MuNu_Run3Summer22EEMiniAODsim_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_postEE_v6 --step PAT --customise Configuration/DataProcessing/Utils.addMonitoring --geometry DB:Extended --era Run3,run3_miniAOD_12X --filein file:AODsim.root --fileout file:MiniAODout.root -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_bphys/cbasile/ppW3MuNu_Run3Summer22EE_pMC_2024Mar18/privateMCProductionAODSimMiniAOD/ppW3MuNumc_evGENSimAODSim/240318_001106/0000/ppW3MuNu_Run3Summer22EEAODsim_1.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ppW3MuNu_Run3Summer22EEMiniAODsim.root'),
